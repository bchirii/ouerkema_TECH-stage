			...
			<?php endif; ?>">
				<?php if ( $header_address ) : ?>
					<div class="contact-info">
						<div class="icon"><?php echo wp_kses_post( consulting_get_icon( 'header_address_icon' ) ); ?></div>
						<div class="text"><?php echo wp_kses_post( $header_address ); ?></div>
					</div>
				<?php endif; ?>
				<?php if ( $header_hours ) : ?>
					<div class="contact-info">
						<div class="icon"><?php echo wp_kses_post( consulting_get_icon( 'header_working_hours_icon' ) ); ?></div>
						<div class="text"><?php echo wp_kses_post( $header_hours ); ?></div>
					</div>
				<?php endif; ?>
				<?php if ( $header_phone ) : ?>
					<div class="contact-info">
						<div class="icon"><?php echo wp_kses_post( consulting_get_icon( 'header_phone_icon' ) ); ?></div>
