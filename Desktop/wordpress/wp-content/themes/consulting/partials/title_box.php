...
$disable_title_box   = ( 'default' !== get_post_meta( $posts_id, 'disable_title_box', true ) ) ? get_post_meta( $posts_id, 'disable_title_box', true ) : consulting_theme_option( 'metabox_disable_title_box' );
$disable_title       = ( 'default' !== get_post_meta( $posts_id, 'disable_title', true ) ) ? get_post_meta( $posts_id, 'disable_title', true ) : consulting_theme_option( 'metabox_disable_title' );
$disable_breadcrumbs = ( 'default' !== get_post_meta( $posts_id, 'disable_breadcrumbs', true ) ) ? get_post_meta( $posts_id, 'disable_breadcrumbs', true ) : consulting_theme_option( 'metabox_disable_breadcrumbs' );
