					...
					'section_page_settings' => array(
						...
						'fields' => array(
							...
							'disable_title_box'            => array(
								...
								'value'   => ( get_post_meta( $post_id, 'disable_title_box', true ) ) ? '' : 'on',
							...
							'enable_transparent'           => array(
								...
								'value'       => ( get_post_meta( $post_id, 'enable_transparent', false ) ) ? 'on' : '',
								'submenu'     => esc_html__( 'Title Box Options', 'stm_post_type' ),
							),
							...
							'disable_title'                => array(
								...
								'value'      => ( get_post_meta( $post_id, 'disable_title', false ) ) ? '' : 'on',
								'dependency' => array(
									'key'   => 'disable_title_box',
									'value' => 'default|| ',
								),
							...
							'disable_breadcrumbs'          => array(
								...
								'value'      => ( get_post_meta( $post_id, 'disable_breadcrumbs', false ) ) ? '' : 'disable',
								'dependency' => array(
									'key'   => 'disable_title_box',
									'value' => 'default|| ',
								),
