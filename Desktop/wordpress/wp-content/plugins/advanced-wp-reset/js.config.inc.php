...
if ( !AWR_IS_PRO_VERSION ) { 
	...
	$popup_infos = \awr\services\CommonService::get_instance()->get_next_pp_infos ();

	$popup_link = $popup_infos['link']; 
	$popup_text = $popup_infos['text']; 

	// FOR THE POPUP : END

	$message_array['awr_pro_url'] = $popup_link;
	$message_array['awr_pro_text'] = $popup_text;
