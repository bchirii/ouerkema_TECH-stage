	...
	<section class="stm_go_pro">
		<div class="container">
			...
			<?php if ( $date_now < '2023-07-21' ) : ?>
				<a href="https://stylemixthemes.com/cost-calculator-plugin/pricing?plugin_coupon=MS23" class="stm-discount" target="_blank">
					<div class="stm-discount-sale">
						<img src='<?php esc_attr_e( CALC_URL . '/frontend/dist/img/go-pro/sale-word.png' ); // phpcs:ignore ?>' alt="Summer Calculator">
					</div>
					<div class="stm-discount-info">
						<div class="stm-discount__title">
							<?php esc_html_e( 'Midsummer Sale! ', 'cost-calculator-builder' ); ?>
							<span><?php esc_html_e( '30% off' ); ?></span>
							<?php esc_html_e( 'for all plugins' ); ?>
						</div>

						<div class="stm-discount__description">
							<img src='<?php esc_attr_e( CALC_URL . '/frontend/dist/img/go-pro/sun.svg' ); // phpcs:ignore ?>' alt="Summer Calculator">
							<span><?php esc_html_e( 'July 6-20 ', 'cost-calculator-builder' ); ?></span>
						</div>
					</div>
					<div class="stm-discount-code">
						<span class="stm-discount-code__label"><?php esc_html_e( 'Coupon code', 'cost-calculator-builder' ); ?></span>
						<span class="stm-discount-code__value"><?php esc_html_e( 'MS23', 'cost-calculator-builder' ); ?></span>
					</div>
				</a>
			<?php endif; ?>
