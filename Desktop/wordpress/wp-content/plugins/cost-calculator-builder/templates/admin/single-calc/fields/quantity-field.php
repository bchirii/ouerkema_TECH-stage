			...
			<div class="row ccb-p-t-15">
				<div class="col-6">
					<div class="ccb-input-wrapper number">
						...
						<div class="ccb-input-box">
							<input type="text" class="ccb-heading-5 ccb-light" name="step" min="0" step="1" @input="errors.step=false" v-model="quantityField.step" placeholder="<?php esc_attr_e( 'Enter field step', 'cost-calculator-builder' ); ?>">
				...
				<div class="col-6">
					<div class="ccb-input-wrapper number">
						...
						<div class="ccb-input-box">
							<input type="text" class="ccb-heading-5 ccb-light" name="default" min="0" step="1" v-model="quantityField.default" placeholder="<?php esc_attr_e( 'Enter field default value', 'cost-calculator-builder' ); ?>">
			...
			<div class="row ccb-p-t-15">
				<div class="col-6">
					<div class="ccb-input-wrapper number">
						...
						<div class="ccb-input-box">
							<input type="text" class="ccb-heading-5 ccb-light" name="min" min="0" step="1" v-model="quantityField.min" placeholder="<?php esc_attr_e( 'Enter field minimum value', 'cost-calculator-builder' ); ?>">
				...
				<div class="col-6">
					<div class="ccb-input-wrapper number">
						...
						<div class="ccb-input-box">
							<input type="text" class="ccb-heading-5 ccb-light" name="max" min="0" step="1" v-model="quantityField.max" placeholder="<?php esc_attr_e( 'Enter field maximum value', 'cost-calculator-builder' ); ?>">
				...
				<div class="col-12">
					<div class="list-header">
						<div class="ccb-multiply">
							...
							<div class="ccb-input-wrapper number">
								<div class="ccb-input-box">
									<input type="text" class="ccb-heading-5 ccb-light" name="unit" min="0" step="1" @input="errors.unit=false" v-model="quantityField.unit" placeholder="<?php esc_attr_e( 'Enter unit', 'cost-calculator-builder' ); ?>">
