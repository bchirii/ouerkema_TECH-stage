				...
				<div class="row ccb-p-t-15">
					<div class="col-6">
						<div class="ccb-input-wrapper number">
							...
							<div class="ccb-input-box">
								<input type="text" class="ccb-heading-5 ccb-light" name="minValue" min="0" step="1" @input="errors.minValue=false" v-model="rangeField.minValue" placeholder="<?php esc_attr_e( 'Enter min range', 'cost-calculator-builder' ); ?>">
					...
					<div class="col-6">
						<div class="ccb-input-wrapper number">
							...
							<div class="ccb-input-box">
								<input type="text" class="ccb-heading-5 ccb-light" name="maxValue" min="0"  step="1" @input="errors.maxValue=false" v-model="rangeField.maxValue" placeholder="<?php esc_attr_e( 'Enter max range', 'cost-calculator-builder' ); ?>">
				...
				<div class="row ccb-p-t-15">
					<div class="col-6">
						<div class="ccb-input-wrapper number">
							...
							<div class="ccb-input-box">
								<input type="text" class="ccb-heading-5 ccb-light" name="step" min="0" step="1" @input="errors.step=false" v-model="rangeField.step" placeholder="<?php esc_attr_e( 'Enter step', 'cost-calculator-builder' ); ?>">
					...
					<div class="col-12">
						<div class="list-header">
							<div class="ccb-multiply">
								...
								<div class="ccb-input-wrapper number">
									<div class="ccb-input-box">
										<input type="text" class="ccb-heading-5 ccb-light" name="unit" min="0" step="1" @input="errors.unit=false" v-model="rangeField.unit" placeholder="<?php esc_attr_e( 'Enter unit', 'cost-calculator-builder' ); ?>">
